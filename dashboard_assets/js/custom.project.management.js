    ...
    function addBoardCard(e) {
        ...
        if( title != "" ) {
            ...
            var left = d.createElement('div');
                ...
                left.innerHTML = '<img src=".././dashboard_assets/img/svg/watch.svg" alt="" class="svg mr-1">';
    ...
    function addList(e) {
        ...
        if( e.keyCode === 13 ) {
            ...
            if( $(this).val() ) {
                ...
                addAnotherCard.innerHTML = '<img src=".././dashboard_assets/img/svg/plus.svg" alt="" class="svg mr-1">';
                ...
                date.innerHTML = '<img src=".././dashboard_assets/img/svg/watch.svg" alt="" class="svg mr-1">';
