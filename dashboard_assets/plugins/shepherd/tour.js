...
$(function() {
    ...
    $(document).ready(function () {
        ...
        t.addStep("step-1", {
            ...
            buttons: [
                { text: `<img src="./dashboard_assets/img/svg/skip.svg" alt="" class="svg"> Skip`, classes: 'text-danger', action: t.complete },
                { text: `Next <img src="./dashboard_assets/img/svg/next.svg" alt="" class="svg">`, action: t.next },
            ],
        }),
            t.addStep("step-2", {
                ...
                buttons: [
                    { text: `<img src="./dashboard_assets/img/svg/skip.svg" alt="" class="svg"> Skip`, classes: 'text-danger', action: t.complete },
                    { text: `<img src="./dashboard_assets/img/svg/prev.svg" alt="" class="svg"> prev`, action: t.back },
                    { text: `Next <img src="./dashboard_assets/img/svg/next.svg" alt="" class="svg">`, action: t.next },
                ],
            }),
            t.addStep("step-3", {
            ...
            t.addStep("step-4", {
                ...
                buttons: [
                    { text: `<img src="./dashboard_assets/img/svg/prev.svg" alt="" class="svg"> prev`, action: t.back },
                    { text: `<img src="./dashboard_assets/img/svg/done-check.svg" alt="" class="svg"> Done`, action: t.complete },
                ],
            });
    });
});